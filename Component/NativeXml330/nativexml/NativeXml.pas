...
function sdCharsetToCodePage(ACharset: AnsiString; ADefaultCodepage: integer = 65001): integer;
// Based on the charset, find the TsdStringEncoding. If no charset is
// matched, the function returns a encoding of seUTF8
function sdCharsetToStringEncoding(ACharset: AnsiString): TsdStringEncoding;

// find the encoding string corresponding to windows codepage
function sdCodepageToCharset(ACodepage: integer): AnsiString;
